...
1. Declares two integer pointer variables, ptrA and ptrB, and assigns them the 
addresses  of two different integer variables. 
...
4. In the main() function, print the values of ptrA and ptrB before calling the  
swapPointers function. 
5. Call the swapPointers function, passing ptrA and ptrB as arguments. 
6. Print the values of ptrA and ptrB after calling the function. They should be 
swapped. 
*/
