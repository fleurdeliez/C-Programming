...
2. Declare an integer pointer and assign it the address of the first element of the array. 3. Use pointer arithmetic to perform the following operations: 
...
c) Subtract 1 from the value pointed to by the pointer and print the result. d) Move the pointer back to the first element and print the value using the pointer. 
*/
